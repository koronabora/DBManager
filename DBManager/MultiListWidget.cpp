...
MultiListWidget::MultiListWidget(const MultiListWidget& w)
	: mCheckedItems(w.mCheckedItems), mDisplayText(w.mDisplayText), mDisplayRectDelta(w.mDisplayRectDelta)	
		{
		}
